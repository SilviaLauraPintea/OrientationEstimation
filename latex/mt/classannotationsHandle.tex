...
\begin{DoxyItemize}
\item argv\mbox{[}1\mbox{]} -\/-\/ the file contains the list of image names (relative paths) \item argv\mbox{[}2\mbox{]} -\/-\/ the file contains the calibration data of the camera \item argv\mbox{[}3\mbox{]} -\/-\/ the file in which the annotation data needs to be stored \end{DoxyItemize}
